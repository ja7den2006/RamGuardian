...
This produces a local release zip at `artifacts\RamGuardian-0.1.2-win-x64.zip`.

Pushing a tag like `v0.1.2` triggers the GitHub Actions release job and publishes the same zip to GitHub Releases.
